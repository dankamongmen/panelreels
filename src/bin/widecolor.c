...
int widecolor_demo(WINDOW* w){
  static const wchar_t* strs[] = {
    ...
    L"⑤ Господ слезе да ги види градот и кулата, што луѓето ги градеа: 🏴☭卐࿗࿕☮࿖࿘卍☭🏴",
    ...
    L"က္ယ္ဝန္တော္၊က္ယ္ဝန္မ မ္ယက္စားနုိင္သည္။ ၎က္ရောင္ ထိခုိက္မ္ဟု မရ္ဟိပာ။ ",
    ...
    L"म काँच खान सक्छू र मलाई केहि नी हुन्न्",
    ...
    L"نا إِىَ تَونَر غِلَاشِ كُمَ إِن غَمَا لَافِىَ",
